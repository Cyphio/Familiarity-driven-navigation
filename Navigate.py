...
class Navigate:
    ...
    def database_analysis(self, spacing):
        ...
        fig = plt.figure(figsize=((self.bounds[1][0] - self.bounds[0][0]) / 100, (self.bounds[1][1] - self.bounds[0][1]) / 100))
...
if __name__ == "__main__":
    ...
    # data = nav.perfect_memory(nav.downsample(cv2.imread("ant_world_image_databases/routes/ant1_route8/image_00000.png")))
    # print(data)