...
if __name__ == "__main__":
    ...
    # one_px_data_path = "DATABASE_ANALYSIS/PERFECTMEMORY/1_deg_px_res/9-3-2021_12-13-22_ant1_route1_140x740_20.csv"
    # two_px_data_path = "DATABASE_ANALYSIS/PERFECTMEMORY/2_deg_px_res/9-3-2021_11-19-55_ant1_route1_140x740_20.csv"
    # four_px_data_path = "DATABASE_ANALYSIS/PERFECTMEMORY/4_deg_px_res/28-2-2021_15-45-13_ant1_route1_140x740_20.csv"
    # eight_px_data_path = "DATABASE_ANALYSIS/PERFECTMEMORY/8_deg_px_res/9-3-2021_10-45-18_ant1_route1_140x740_20.csv"
    # pm.error_boxplot([one_px_data_path, two_px_data_path, four_px_data_path, eight_px_data_path], save_data=True)
    # threshold = 20
